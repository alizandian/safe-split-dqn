...
class AgentSafeDQNSplitted(object):
    def __init__(self, input_dim, output_dim, nn_model, monitor_nn_model, gamma = 1.0, replay_buffer_size = 500, target_update_interval = 100, verbose = False):
        ...
        self.dqn = DQNSplited(input_dim = input_dim, output_dim = output_dim,nn_model = nn_model, gamma = gamma, verbose = verbose)
